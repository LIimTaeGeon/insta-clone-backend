...
def post_list(request, tag=None):
    ...
    if tag:
        post_list = Post.objects.filter(tag_set__name__iexact=tag) \
            .prefetch_related('tag_set', 'like_user_set__profile', 'comment_set__author__profile__follower_user', 'author__profile__follower_user__from_user') \
...
def post_like(request):
    ...
    context = {'like_conunt': post.like_count,
               'message': message}
...
def post_bookmark(request):
    ...
    context = {'bookmark_conunt': post.bookmark_count,
               'message': message}
    return HttpResponse(json.dumps(context), content_typ="application/json")
